LEXICON_RU: dict[str, str] = {
    ...
    '/help': 'Всё очень просто, если ты сотрудник, то есть доступ.\n'
    ...
    'input_phone_number': 'Введи номер телефона в таком формате <b>+7 777 777 7777</b>',
...
LEXICON_BUTTON: dict[str,str] = {
    'main': 'Главная',
    'catalog': 'Каталог',
    'example': 'Пример для поиска: <b>"пылесос samsung"</b>',
